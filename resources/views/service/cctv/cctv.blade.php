                ...
                <div class="col-12 col-lg-6">
                    <div class="pt-25 pb-35 position-static position-lg-relative breadcrumbs__subtitle">
                        <h3 class="brk-white-font-color font__family-montserrat font__weight-medium font__size-18 line__height-21 text-uppercase mb-15">
                            Kenal lebih banyak tentang CCTV
                        </h3>
    ...
    <main class="main-container pt-100">
        <section>
            <div class="container">
                <div class="col-lg-12">
                    <div class="container">
                        <h2 class="title__heading-03 title__heading-main text-center font__family-montserrat-alt font__weight-bold font__size-40" data-brk-library="component__title">Solusi Pengembangan CCTV dengan HIXVISION</h2>
                    ...
                    <p class="font__family-open-sans ml-10 font__size-15 line__height-24 brk-dark-font-color mt-20">Kami menyediakan sistem keamanan berbasis CCTV dengan perangkat berkualitas dari Hikvision, merek terkemuka dalam industri pengawasan video. Dengan teknologi terbaru yang menawarkan resolusi tinggi, fitur AI, dan integrasi cloud, sistem CCTV kami cocok untuk berbagai kebutuhan, baik untuk rumah, bisnis, maupun industri.</p>
                </div>
            </div>
        </section>
        <section class="mt-60">
            <div class="title-simple">
                <h3 class="font__family-montserrat font__weight-bold text-center" data-brk-library="component__title">Produk Camera Hixvision yang Kami Tawarkan</h3>
            </div>
        </section>
        <section>
            <div class="container mb-70 mt-50" id="description">
                <div class="container">
                    <h3 class="font__family-montserrat font__size-28 font__weight-bold text-left"><span class="heading__number">01</span> IP CAMERA HIXVISION</h3>
                </div>
                <div class="row no-gutters align-items-center">
                    <div class="col-xl-8 order-xl-1 text-center">
                        <span class="app-img-caption">IP CAMERA</span>
                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('img/cctv/cctv.png')}}" class="lazyload" alt="alt">
                    </div>
                    <div class="col-md-4 col-xl-2">
                        <div class="text-center text-xl-right mt-50 wow fadeInLeft">
                            ...
                            <p class="font__family-open-sans font__size-14 text-gray mt-10">Resolusi Ultra HD (2MP – 8MP hingga 4K) untuk gambar yang lebih tajam dan jelas.</p>
                        </div>
                        <div class="text-center text-xl-right mt-50 wow fadeInLeft">
                            <svg class="svg-md svg-blue" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60">
                            ...
                            <p class="font__family-open-sans font__size-14 text-gray mt-10">Night Vision (EXIR & IR Cut Filter) untuk pengawasan dalam kondisi minim cahaya.</p>
                        </div>
                        <div class="text-center text-xl-right mt-50 wow fadeInLeft">
                            <svg class="svg-md svg-blue" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60">
                                <circle fill="none" stroke="#34495E" stroke-width="2" stroke-linecap="square" stroke-miterlimit="10" cx="15" cy="13" r="6" />
                            ...
                            <p class="font__family-open-sans font__size-14 text-gray mt-10">Fitur WDR (Wide Dynamic Range) untuk menangani area dengan pencahayaan berlebih atau kurang.</p>
                        </div>
                    </div>

                    <div class="col-md-4 col-xl-2 order-xl-2">
                        <div class="text-center text-xl-left mt-50 wow fadeInRight">
                            <svg class="svg-md svg-blue" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60">
                            ...
                            <p class="font__family-open-sans font__size-14 text-gray mt-10">Deteksi Gerakan & Peringatan Cerdas berbasis AI.</p>
                        </div>
                        <div class="text-center text-xl-left mt-50 wow fadeInRight">
                            <svg class="svg-md svg-blue" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60">
                            ...
                            <p class="font__family-open-sans font__size-14 text-gray mt-10">Akses Cloud & Mobile App Hik-Connect untuk pemantauan jarak jauh.</p>
                        </div>
                        <div class="text-center text-xl-left mt-50 wow fadeInRight">
                            <svg class="svg-md svg-blue" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60">
                                <path fill="none" stroke="#34495E" stroke-width="2" stroke-linecap="square" stroke-miterlimit="10" d="M52.97,28.91C52.99,29.27,53,29.63,53,30" />
                            ...
                            <p class="font__family-open-sans font__size-14 text-gray mt-10">Dukungan PoE (Power over Ethernet) untuk pemasangan lebih mudah dan rapi.</p>
                        </div>
                    </div>
                        ...
                        <div>
                            <div class="brk-ic-left-slide brk-ic-left-slide__pointer" data-brk-library="component__image_caption_css">
                                ...
                                <div class="brk-ic-left-slide__wrapper brk-ic-left-slide__wrapper_gradient brk-base-bg-gradient-50deg-a">
                                    ...
                                    <p class="font__size-12 font__family-open-sans line__height-26 text-white" data-brk-library="component__title">Kamera berbentuk kubah, ideal untuk indoor dengan tampilan estetis.</p>
                        ...
                        <div>
                            <div class="brk-ic-left-slide brk-ic-left-slide__pointer" data-brk-library="component__image_caption_css">
                                ...
                                <div class="brk-ic-left-slide__wrapper brk-ic-left-slide__wrapper_gradient brk-base-bg-gradient-50deg-a">
                                    ...
                                    <p class="font__size-12 font__family-open-sans line__height-26 text-white" data-brk-library="component__title">Kamera dengan jarak pandang lebih jauh, cocok untuk outdoor.</p>
                        ...
                        <div>
                            <div class="brk-ic-left-slide brk-ic-left-slide__pointer" data-brk-library="component__image_caption_css">
                                ...
                                <div class="brk-ic-left-slide__wrapper brk-ic-left-slide__wrapper_gradient brk-base-bg-gradient-50deg-a">
                                    ...
                                    <p class="font__size-12 font__family-open-sans line__height-26 text-white" data-brk-library="component__title">Kamera yang dapat bergerak dan memperbesar gambar dengan kontrol otomatis/manual.</p>
            ...
            <div class="container mb-70 mt-50" id="description">
                <div class="container">
                    <h3 class="font__family-montserrat font__size-28 font__weight-bold text-left"><span class="heading__number">02</span> NVR (Network Video Recorder) HIXVISION </h3>
                </div>
                <div class="row no-gutters align-items-center">
                    <div class="col-xl-8 order-xl-1 text-center">
                        <span class="app-img-caption">NVR</span>
                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('img/cctv/nvr.png')}}" class="lazyload" alt="alt">
                    </div>
                    <div class="col-md-6 col-xl-2">
                        <div class="text-center text-xl-right mt-50 wow fadeInLeft">
                            ...
                            <p class="font__family-open-sans font__size-14 text-gray mt-10"> Mendukung Resolusi 4K untuk perekaman berkualitas tinggi.</p>
                        </div>
                        <div class="text-center text-xl-right mt-50 wow fadeInLeft">
                            <svg class="svg-md svg-blue" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60">
                                <circle fill="none" stroke="#34495E" stroke-width="2" stroke-linecap="square" stroke-miterlimit="10" cx="15" cy="13" r="6" />
                            ...
                            <p class="font__family-open-sans font__size-14 text-gray mt-10">Penyimpanan berbasis HDD & Cloud dengan kapasitas besar.</p>
                        </div>
                        <div class="text-center text-xl-right mt-50 wow fadeInLeft">
                            <svg class="svg-md svg-blue" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60">
                                <circle fill="none" stroke="#34495E" stroke-width="2" stroke-linecap="square" stroke-miterlimit="10" cx="15" cy="13" r="6" />
                        ...
                        <div>
                            <div class="brk-ic-left-slide brk-ic-left-slide__pointer" data-brk-library="component__image_caption_css">
                                ...
                                <div class="brk-ic-left-slide__wrapper brk-ic-left-slide__wrapper_gradient brk-base-bg-gradient-50deg-a">
                                    ...
                                    <p class="font__size-12 font__family-open-sans line__height-26 text-white" data-brk-library="component__title">8-Channel, 16-Channel, 32-Channel – Sesuai dengan jumlah kamera yang digunakan.</p>
            ...
            <div class="container mb-70 mt-50" id="description">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-xl-8 order-xl-1 text-center">
                        <span class="app-img-caption">DVR</span>
                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('img/cctv/dvr.png')}}" class="lazyload" alt="alt">
                    </div>
                    <div class="col-md-4 col-xl-2">
                        <div class="text-center text-xl-right mt-50 wow fadeInLeft">
                            <svg class="svg-md svg-blue" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-12">
                            <h2 class="brk-white-font-color font__family-montserrat font__size-56 line__height-64 font__weight-bold text-center text-sm-center pb-sm-40 pb-15">Layanan Tambahan Berbasis AI & Pengolahan Citra</h2>
                        </div>
                    </div>
                </div>
                                        ...
                                        <li class="font__family-montserrat font__size-16 font__weight-bold">
                                            <a href="#">
                                                <span class="text">
                                                    ...
                                                    </span> Deteksi Plat Nomor Kendaraan untuk sistem parkir otomatis atau pemantauan lalu lintas.
                                                </span>
                                            </a>
                                        </li>
                                        <li class="font__family-montserrat font__size-16 font__weight-bold">
                                            ...
                                            <a href="#">
                                                <span class="text">
                                                    <span class="cirlce">
                                                        <span class="before"></span>
                                                        <span class="after"></span>
                                                    </span> Akses Kontrol Berbasis Kamera – Sistem yang mengizinkan masuk hanya bagi orang tertentu. </span>
                                            </a>
                                        </li>
                                        <li class="font__family-montserrat font__size-16 font__weight-bold">
                                            <span class="text">
                                                <span class="cirlce">
                                                    <span class="before"></span>
                                                    <span class="after"></span>
                                                </span> Analisis Kepadatan Orang – Cocok untuk mall, gedung perkantoran, dan fasilitas umum.</span>
                                        </li>
                                        <li class="font__family-montserrat font__size-16 font__weight-bold">
                                            <span class="text">
                                                <span class="cirlce">
                                                    <span class="before"></span>
                                                    <span class="after"></span>
                                                </span> Deteksi Kebakaran & Asap dengan Kamera Termal untuk meningkatkan keselamatan.</span>
                                        </li>
                    ...
                    <div class="row row-no-gutter">
                        <div class="col-lg-6">
                            <div class="icon__wrapper active__effect pt-50 pb-50">
                                ...
                                <span class="after"></span>
                                <h4 class="font__family-montserrat font__size-28 font__weight-bold">Deep Learning & Computer Vision</h4>
                                <p class="font__family-open-sans font__size-14 line__height-21">YOLO, OpenCV, TensorFlow</p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="icon__wrapper active__effect active current pt-50 pb-50">
                                ...
                                <span class="tri-after"></span>
                                <span class="after"></span>
                                <h4 class="font__family-montserrat font__size-28 font__weight-bold"> Integrasi IoT & Cloud</h4>
                                <p class="font__family-open-sans font__size-14 line__height-21">Google Cloud, AWS, Firebase</p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="icon__wrapper active__effect pt-50 pb-50">
                                ...
                                <span class="tri-after"></span>
                                <span class="after"></span>
                                <h4 class="font__family-montserrat font__size-28 font__weight-bold">Keamanan Data </h4>
                                <p class="font__family-open-sans font__size-14 line__height-21">Enkripsi tingkat tinggi, penyimpanan berbasis cloud</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="icon__wrapper active__effect pt-50 pb-50">
                                ...
                                <span class="tri-after"></span>
                                <span class="after"></span>
                                <h4 class="font__family-montserrat font__size-28 font__weight-bold">Dashboard & Laporan </h4>
                                <p class="font__family-open-sans font__size-14 line__height-21"> Sistem analitik untuk pemantauan data real-time</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container mt-60">
                        <div class="tabs-wrapper maxw-970">
                            ...
                            <div id="tab-group-2" class="tabgroup text-lg-left text-center mt-60">
                                <div id="tab-2_1">
                                    <h4 class="font__family-montserrat font__weight-ultralight font__size-21 letter-spacing-40 text-uppercase">Konsultasi & Perencanaan </h4>
                                    <ul class="list-inline-2" data-brk-library="component__list">
                                        <li class="font__family-montserrat font__size-16 font__weight-bold">
                                            <a href="#">
                                                <span class="text">
                                                    <span class="cirlce">
                                                        <span class="before"></span>
                                                        <span class="after"></span>
                                                    </span> Analisis kebutuhan sistem CCTV & AI yang tepat.</span>
                                            </a>
                                        </li>
                                ...
                                <div id="tab-2_4">
                                    <h4 class="font__family-montserrat font__weight-ultralight font__size-21 letter-spacing-40 text-uppercase">4. Pelatihan & Penggunaan
                                    </h4>
                                    <ul class="list-inline-2" data-brk-library="component__list">
                                ...
                                <div id="tab-2_5">
                                    <h4 class="font__family-montserrat font__weight-ultralight font__size-21 letter-spacing-40 text-uppercase">5. Pemeliharaan & Update</h4>
                                    <ul class="list-inline-2" data-brk-library="component__list">
                                            ...
                                            <a href="#">
                                                <span class="text">
                                                    <span class="cirlce">
                                                        <span class="before"></span>
                                                        <span class="after"></span>
                                                    </span> Layanan perawatan dan peningkatan sistem secara berkala. </span>
                                            </a>
                                        </li>
        ...
        <section class="pt-60 pb-40">
            <div class="container" data-brk-library="component__tables">
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-12">
                            <h2 class="brk-black-font-color font__family-montserrat font__size-56 line__height-64 font__weight-bold text-center text-sm-center pb-sm-40 pb-15">Daftar Portfolio CCTV</h2>
                        </div>
                    </div>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td data-title="Kategori">Politeknik Negeri Malang</td>
                                <td data-title="Last Name">Malang</td>
                                <td data-title="Username">2023</td>
                            </tr>
                            <tr>
                                <td data-title="#">02</td>
                                <td data-title="First Name">Pemasangan CCTV 10 Camera</td>
                                <td data-title="Kategori">DVR Hixvision</td>
                                <td data-title="Kategori">Muhammad Ilham, Kandang Ayam</td>
                            ...
                            <tr>
                                <td data-title="#">03</td>
                                <td data-title="First Name">Pemasangan CCTV 15 Camera</td>
                                <td data-title="Kategori">DVR Hixvision</td>
                                <td data-title="Kategori">Toko Bangunan Al Ishlah</td>
                                <td data-title="Last Name">Pasuruan </td>
                                <td data-title="Username">2024</td>
                            </tr>
                            <tr>
                                <td data-title="#">04</td>
                                <td data-title="First Name">Pemasangan CCTV 5 Camera</td>
                                <td data-title="Kategori">DVR Hixvision</td>
                                <td data-title="Kategori">Greenhouse Hidroponik</td>
                                <td data-title="Last Name">Pasuruan</td>
                                <td data-title="Username">2024</td>
                            </tr>
                            <tr>
                                <td data-title="#">05</td>
                                <td data-title="First Name">Pengolahan Citra Hemat Energi</td>
                                <td data-title="Kategori">DVR Hixvision, Pengolahan Citra</td>
                                <td data-title="Kategori">Greenhouse Hidroponik</td>
                                <td data-title="Last Name">Pasuruan</td>
                                <td data-title="Username">2024</td>
                            </tr>
                            <tr>
                                <td data-title="#">06</td>
                                <td data-title="First Name">IP Camera Sistem kemanan maling</td>
                                <td data-title="Kategori">Pengolahan Citra,IP Camera</td>
                                <td data-title="Kategori">Toko Baju</td>
                                <td data-title="Last Name">Pasuruan</td>
                                <td data-title="Username">2024</td>
                            </tr>
                            <tr>
                                <td data-title="#">07</td>
                                <td data-title="First Name">IP Camera Sistem kemanan Brankas</td>
                                <td data-title="Kategori">Pengolahan Citra,IP Camera</td>
                                <td data-title="Kategori">Toko Emas</td>
                                <td data-title="Last Name">Bangkalan</td>
                                <td data-title="Username">2024</td>
                            </tr>

                            <tr>
                                <td data-title="#">08</td>
                                <td data-title="First Name">IP Camera Deteksi Wajah Karyawan</td>
                                <td data-title="Kategori">Pengolahan Citra,IP Camera</td>
                                <td data-title="Kategori">Industri Kontruksi</td>
                                <td data-title="Last Name">Kediri</td>
                                <td data-title="Username">2024</td>
                            </tr>
